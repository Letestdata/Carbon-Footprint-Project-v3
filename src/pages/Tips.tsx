...
export function Tips() {
  ...
  const totalPotentialSaving = useMemo(
    () =>
      filteredTips
        .filter((t) => savedTips.has(t.id))
        .reduce((s, t) => s + t.potentialSaving, 0),
  ...
  return (
    <div className="space-y-6">
      ...
      <section aria-labelledby="tips-list-heading">
        <h2 id="tips-list-heading" className="sr-only">
          Available Tips
        </h2>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="mt-3 flex items-center justify-between flex-wrap gap-2">
                        ...
                        <button
                          ...
                          aria-label={
                            isSaved
                              ? `Remove "${tip.title}" from saved tips`
                              : `Save "${tip.title}"`
                          }
