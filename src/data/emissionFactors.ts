...
export const EMISSION_FACTORS: EmissionFactor[] = [
  ...
  {
    label: "International flight (economy)",
    unit: "km",
    kgCo2ePerUnit: 0.195,
    category: "transport",
  ...
  },
  {
    ...
    kgCo2ePerUnit: 0.015,
    category: "energy",
    subcategory: "electricity_renewable",
  },
  {
    label: "Natural gas",
    unit: "kWh",
  ...
  {
    label: "Vegetables (local)",
    unit: "kg",
    kgCo2ePerUnit: 0.4,
    category: "food",
    subcategory: "vegetables_local",
  },
  {
    label: "Vegetables (imported)",
    unit: "kg",
    kgCo2ePerUnit: 1.5,
    category: "food",
    subcategory: "vegetables_imported",
  },
  {
    label: "Fruits (local)",
    unit: "kg",
    kgCo2ePerUnit: 0.5,
    category: "food",
    subcategory: "fruits_local",
  },
  {
    label: "Legumes / Lentils",
    unit: "kg",
    kgCo2ePerUnit: 0.9,
    category: "food",
    subcategory: "legumes",
  ...
  // ── Shopping ──────────────────────────────────────────────
  {
    label: "New clothing (average)",
    unit: "item",
    kgCo2ePerUnit: 7.0,
    category: "shopping",
    subcategory: "clothing_new",
  },
  {
    label: "Second-hand clothing",
    unit: "item",
    kgCo2ePerUnit: 0.9,
    category: "shopping",
    subcategory: "clothing_secondhand",
  },
  {
